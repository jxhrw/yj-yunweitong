                ...
                <div class="complete-content">
                    <el-row class="content-row-select">
                        <el-col :span="20">
                            ...
                            <!-- <el-checkbox v-model="isRecover" style="margin-left: 15px;">关闭设备状态为正常</el-checkbox> -->
                        </el-col>
                    </el-row>
    ...
    export default {
        ...
        methods: {
            ...
            sureWorkorders(isPass) {
                ...
                this.isAjaxing = true;
                this.$api.putByQs(`${this.$config.efoms_HOST}/workorderssystem/info/close`, {
