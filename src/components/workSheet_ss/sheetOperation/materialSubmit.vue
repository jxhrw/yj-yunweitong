      ...
      .cl8 {
        ...
        .ms-files {
          ...
          .icon-file {
            ...
            &.file-doc {
              background: url("../../../assets/images/file-word.png") no-repeat
                center/20px;
            }

            &.file-xls {
              background: url("../../../assets/images/file-execl.png") no-repeat
                center/20px;
            }

            &.file-other {
              background: url("../../../assets/images/file-file.png") no-repeat
                center/20px;
            }
          }
        }
