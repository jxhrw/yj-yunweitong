            ...
            <div class="operation-content">
                <div class="complete-content">
                    <el-row class="content-row-select">
                        <el-col :span="20">
                            <label>确认意见</label>
                            <el-input v-model="operExplain" placeholder="请输入" size='mini' class="content-select" style="width: 400px;" clearable></el-input>
    ...
    export default {
        ...
        methods: {
            ...
            sureWorkorders(isPass) {
                ...
                this.isAjaxing = true;
                this.$api.putByQs(`${this.$config.efoms_HOST}/workordersOther/sureWorkordersOther`, {
