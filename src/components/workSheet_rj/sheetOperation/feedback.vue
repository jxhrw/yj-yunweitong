            ...
            <div class="operation-content">
                <div class="complete-content">
                    ...
                    <el-row class="content-row-select">
                        ...
                        <el-col :span="9">
                            <label class="content-label"><span>*</span>反馈说明</label>
    ...
    export default {
        ...
        methods: {
            ...
            fackbackWorkorders() {
                ...
                if (this.operExplain == '') {
                    Common.ejMessage("warning", "反馈说明必填");
                    return;
                }
                ...
                //     return;
                // }
                var url = `${this.$config.efoms_HOST}/workordersOther/fackbackWorkordersOther`;
                url = url + '?workOtherId=' + this.workordersInfo.workOtherId +
