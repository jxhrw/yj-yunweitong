...
const webpackConfig = merge(baseWebpackConfig, {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([{
                from: path.resolve(__dirname, '../static/config/config.json'), // 外部配置js:out-config.js文件：不参与编译打包的，直接从static文件夹下复制一份到dist目录下
            ...
            // },
            {
                ...
                to: config.build.assetsPublicPath + '/static',
                ignore: ['.*']
            },
            // {
            //     from: path.resolve(__dirname, '../static/js/jquery-2.1.4.min.js'),
            ...
            //     to: config.build.assetsPublicPath + '/static/UEditor',
            //     ignore: ['.*']
            // }
        ])
